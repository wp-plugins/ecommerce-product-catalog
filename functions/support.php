			...
			<div class="setting-content submenu support-tab">
			  ...
			  <p><?php _e('If you found eCommerce Product Catalog useful or it saved you some amount of time please consider to support its development by buying premium support or an extension. This is better than a donation, because you get even more value with it. All the income from premium support and extensions goes for eCommerce Product Catalog and its extensions development. Everybody wins.','al-ecommerce-product-catalog'); ?></p> */ ?>
				...
				<div class="extension premium-support">
					...
					<p><?php _e( '<b>One year</b> of high quality and speedy email', 'al-ecommerce-product-catalog' ) ?> <a href="https://implecode.com/wordpress/plugins/premium-support/#cam=catalog-support-tab&key=support-link">Premium Support</a> <?php _e( 'from impleCode support team for just', 'al-ecommerce-product-catalog' ) ?> $19.99.</p>
				...
				<div class="extension premium-support">
					...
					<p><?php echo sprintf( __( '<b>Extensions</b> provide additional useful features. They improve eCommerce Product Catalog in a field of <a href="%1$s">SEO</a>, <a href="%3$s">Productivity</a>, <a href="%2$s">Usability</a> and <a href="%4$s">Conversion</a>.', 'al-ecommerce-product-catalog' ), esc_url( 'https://implecode.com/wordpress/plugins/?cam=catalog-support-tab&key=extensions-link-seo#seo_usability_boosters' ), esc_url( 'https://implecode.com/wordpress/plugins/?cam=catalog-support-tab&key=extensions-link-usability#seo_usability_boosters' ), esc_url( 'https://implecode.com/wordpress/plugins/?cam=catalog-support-tab&key=extensions-link-productivity#productivity_boosters' ), esc_url( 'https://implecode.com/wordpress/plugins/?cam=catalog-support-tab&key=extensions-link-conversion#conversion_boosters' ) ) ?></p>
				...
				<p><?php echo sprintf( __( 'If you need to get it on different email address please use the <a href="%s">impleCode website to order the premium support</a>. It will let you set different email address than the one for PayPal.', 'al-ecommerce-product-catalog' ), esc_url( 'https://implecode.com/wordpress/plugins/premium-support/#cam=catalog-support-tab&key=support-link-1' ) ); ?></p>
				<h2><?php _e( 'Theme Integration', 'al-ecommerce-product-catalog' ) ?></h2>
				<p><?php echo sprintf( __( 'As you may already know some themes may need Theme Integration to fully support eCommerce Product Catalog. I wrote this <a href="%1$s">theme integrations guide</a>, however to make it even easier you will get <a href="%2$s">Advanced Theme Integration</a> service for free if you choose <a href="%3$s">Premium Support</a> service.', 'al-ecommerce-product-catalog' ), esc_url( 'https://implecode.com/wordpress/product-catalog/theme-integration-guide/#cam=catalog-support-tab&key=integration-link' ), esc_url( 'https://implecode.com/wordpress/plugins/advanced-theme-integration/#cam=catalog-support-tab&key=integration-service-link' ), esc_url( 'https://implecode.com/wordpress/plugins/premium-support/#cam=catalog-support-tab&key=support-link-2' ) ) ?></p>
				<h2><?php _e( 'eCommerce Product Catalog documentation', 'al-ecommerce-product-catalog' ) ?></h2>
				<p><?php echo sprintf( __( '<b>eCommerce Product Catalog</b> documentation is being developed <a href="%1$s">here</a>. For questions about eCommerce Product Catalog please use <a href="%2$s">support forum</a> or <a href="%3$s">Premium Support service</a>.', 'al-ecommerce-product-catalog' ), esc_url( 'https://implecode.com/wordpress/product-catalog/#cam=catalog-support-tab&key=docs-link' ), esc_url( 'http://wordpress.org/support/plugin/ecommerce-product-catalog' ), esc_url( 'https://implecode.com/wordpress/plugins/premium-support/#cam=catalog-support-tab&key=support-link-3' ) ) ?></p>
				<?php /*
				  ...
				  <td>
				  <ul class="support-ul">
				  <li><a target="_blank" href="https://implecode.com/wordpress/plugins/custom-product-order/#cam=catalog-support-tab&key=custom-product-order-link">Custom Product Order</a> - <?php _e('show products in custom order, show featured products always on top', 'al-ecommerce-product-catalog') ?></li>
				  <li><a target="_blank" href="https://implecode.com/wordpress/plugins/upload-pdf/#cam=catalog-support-tab&key=upload-pdf-link">Upload PDF</a> - <?php _e('a downloadable PDF attached to the product', 'al-ecommerce-product-catalog') ?></li>
				  <li><a target="_blank" href="https://implecode.com/wordpress/plugins/product-search-pro/#cam=catalog-support-tab&key=product-search-pro-link">Product Search PRO</a> - <?php _e('better product search, completely rewritten search engine', 'al-ecommerce-product-catalog') ?></li>
				  <li><a target="_blank" href="https://implecode.com/wordpress/plugins/smarter-product-urls/#cam=catalog-support-tab&key=smarter-product-urls-link">Smarter Product URLs</a> - <?php _e('URL structure improved for SEO and Usability purpose', 'al-ecommerce-product-catalog') ?></li>
				  <li><a target="_blank" href="https://implecode.com/wordpress/plugins/product-gallery-advanced/#cam=catalog-support-tab&key=gallery-advanced-link">Product Gallery Advanced</a> - <?php _e('add more images and show them in lightbox', 'al-ecommerce-product-catalog') ?></li>
				  ...
				  <td>
				  <ul class="support-ul">
				  <li><a target="_blank" href="https://implecode.com/wordpress/plugins/drop-attributes/#cam=catalog-support-tab&key=drop-down-attributes-link">Drop-down Attributes</a> - <?php _e('limit possible values for certain attributes', 'al-ecommerce-product-catalog') ?></li>
				  </ul>
				  </td>
				  <td>
				  <ul class="support-ul">
				  <li><a target="_blank" href="https://implecode.com/wordpress/plugins/quote-form/#cam=catalog-support-tab&key=quote-form-link">Quote Form</a> - <?php _e('allow users to ask for a quote for individual products', 'al-ecommerce-product-catalog') ?></li>
				  <li><a target="_blank" href="https://implecode.com/wordpress/plugins/paypal-gateway/#cam=catalog-support-tab&key=paypal-gateway-link">PayPal Gateway</a> - <?php _e('allow fast PayPal payments through order form', 'al-ecommerce-product-catalog') ?></li>
				  <li><a target="_blank" href="https://implecode.com/wordpress/plugins/order-form/#cam=catalog-support-tab&key=order-form-link">Order Form</a> - <?php _e('allow users to order individual products (not a shopping cart), good when users buy only one product at a time', 'al-ecommerce-product-catalog') ?></li>
				  </ul>
				  </td>
				  </tr>
				  </tbody>
				...
				<p style="border: 1px solid; padding: 10px 10px 26px 10px;">
					<a style="float: left; margin-right: 10px;" href="https://implecode.com/wordpress/plugins/premium-support/#cam=catalog-support-tab&key=donation-support-link"><img height="60px" src="<?php echo AL_PLUGIN_BASE_PATH . 'img/do-not-donate.png' ?>" /></a><?php echo sprintf( __( '<b>Please do not donate</b> (we finance the eCommerce Product Catalog development from <a href="%1$s">premium support</a> and <a href="%2$s">extensions</a>)', 'al-ecommerce-product-catalog' ), esc_url( 'https://implecode.com/wordpress/plugins/premium-support/#cam=catalog-support-tab&key=donation-support-link' ), esc_url( 'https://implecode.com/wordpress/plugins/?cam=catalog-support-tab&key=donation-extensions-link#extensions' ) ) ?>.
				</p>
			</div>
			<div class="helpers"><div class="wrapper"><?php
					main_helper();
					did_know_helper( 'support', __( 'You can get instant premium support from plugin developers', 'al-ecommerce-product-catalog' ), 'https://implecode.com/wordpress/plugins/premium-support/' );
					review_helper()
					?>
				</div></div><?php
		}
