...
function product_extensions() { ?>
	...
	<h2><?php _e('Extensions', 'al-ecommerce-product-catalog') ?> - impleCode eCommerce Product Catalog</h2>
		<h2 class="nav-tab-wrapper">
			...
			<a id="help" class="nav-tab" href="<?php echo admin_url('edit.php?post_type=al_product&page=extensions.php&tab=help') ?>"><?php _e('Help', 'al-ecommerce-product-catalog'); ?></a>
		</h2>
	<div class="table-wrapper">
		...
		if ($tab == 'product-extensions' OR $tab == '') { ?>
			...
			<div class="helpers"><div class="wrapper"><h2><?php _e('Did you Know?', 'al-ecommerce-product-catalog') ?></h2><?php
			...
			echo '<p>Please see the <a target="_blank" href="http://implecode.com/faq/?cam=extensions-help&key=faq">FAQ</a> for additional information</p>';echo '</div>'; ?>
			<div class="helpers"><div class="wrapper"><h2><?php _e('Did you Know?', 'al-ecommerce-product-catalog') ?></h2><?php
